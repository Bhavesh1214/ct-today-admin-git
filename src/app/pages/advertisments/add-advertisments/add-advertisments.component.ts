...
@Component({
  selector: 'app-add-advertisments',
  imports: [FormsModule,
    ReactiveFormsModule,
    ButtonModule,
    RouterModule,
  ...
  templateUrl: './add-advertisments.component.html',
  styleUrl: './add-advertisments.component.scss',
  providers:[MessageService]
})


export class AddAdvertismentsComponent {
  submitted = false;
  id: any = null;
