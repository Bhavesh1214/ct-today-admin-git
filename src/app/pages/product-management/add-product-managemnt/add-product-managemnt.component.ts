...
@Component({
  selector: 'app-add-product-managemnt',
  imports: [
    FormsModule,
    ReactiveFormsModule,
    ButtonModule,
  ...
  templateUrl: './add-product-managemnt.component.html',
  styleUrl: './add-product-managemnt.component.scss'
})
export class AddProductManagemntComponent {
  submitted = false;
  id: any = null;
